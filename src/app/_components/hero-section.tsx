...
export const HeroSection = () => (
  <section className="w-full md:min-h-[600px] min-h-[300px] flex flex-col items-center justify-center text-center bg-gradient-to-br from-[#3EB9E5] via-[#A759A3] to-[#F7A442] py-16 relative overflow-hidden">
